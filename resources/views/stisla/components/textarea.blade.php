...
$value_temp           = $value ?? '';
$is_value             = old($name_temp) ? old($name_temp) : ($value_temp ? $value_temp : '');
...
<div class="form-group">
  ...
  <div class="input-group">
    ...
    @endisset
      ...
      <textarea id="{{ $id }}" {!! $is_name !!} {!! $is_type !!} {!! $is_required !!} {!! $is_min !!} {!! $is_max !!} {!! $is_disabled !!} {!! $is_readonly !!} {!! $is_accept !!}  class="form-control {{ $class_append ?? '' }} {{ $status_class }}">{!! $is_value !!}</textarea>
