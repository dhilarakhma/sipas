...
<div class="form-group">
  ...
  @isset($ikon)
    ...
    <input id="{{ $id }}" {!! $is_name !!} {!! $is_type !!} {!! $is_required !!} {!! $is_min !!} {!! $is_max !!} {!! $is_disabled !!} {!! $is_readonly !!}
      {!! $is_accept !!} {!! $is_value !!} class="form-control {{ $class_append ?? '' }} {{ $status_class }}" {!! $is_disabled !!}>
